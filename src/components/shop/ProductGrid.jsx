      ...
      <div className="row g-4" id="productContainer">
        {products.map((product) => (
          ...
          >
            ...
            >
              <div className="card border-0 bg-transparent position-relative overflow-hidden product-shop-card">
                ...
                <div className="bg-light position-relative">
                  ...
                  />
                  <button
                    className="btn btn-dark text-white position-absolute start-50 translate-middle-x px-3 py-2 rounded add-to-cart-btn"
